...
output "bucket_arn" {
  ...
  value       = module.s3_backup
}
##
output "bucket_region" {
  description = "S3 bucket region"
  value       = module.s3_backup.bucket_region
}

output "bucket_regional_domain_name" {
  description = "S3 bucket regional domain name"
  value       = module.s3_backup.bucket_regional_domain_name
}
...
output "versioning_enabled" {
  ...
  value       = module.s3_backup.versioning_enabled
}

output "mfa_delete_enabled" {
  description = "Whether MFA delete is enabled"
  value       = module.s3_backup.mfa_delete_enabled
}

output "object_lock_enabled" {
  description = "Whether object lock is enabled"
  value       = module.s3_backup.object_lock_enabled
}
...
output "encryption_type" {
  ...
  value       = module.s3_backup.encryption_type
}
