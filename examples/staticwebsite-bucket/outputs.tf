...
output "versioning_enabled" {
  ...
  value       = module.s3_website.versioning_enabled
}

output "mfa_delete_enabled" {
  description = "Whether MFA delete is enabled"
  value       = module.s3_website.mfa_delete_enabled
}

output "object_lock_enabled" {
  description = "Whether object lock is enabled"
  value       = module.s3_website.object_lock_enabled
}
...
output "encryption_type" {
  ...
  value       = module.s3_website.encryption_type
}
